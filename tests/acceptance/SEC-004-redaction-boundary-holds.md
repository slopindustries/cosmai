...
- `PASS`
- Linked experiment measurement: [EXP-001](../../experiments/integrated-p0/EXP-001-platform-core.md) — 59 passed via `./scripts/with-database.sh uv run pytest experiments/integrated-p0/tests -k sec_004`. Evidence directory: `experiments/integrated-p0/evidence/2026-08-17-5b26d47/`.
