...
- `PASS`
- Linked experiment measurement: [EXP-001](../../experiments/integrated-p0/EXP-001-platform-core.md) — 11 passed via `./scripts/with-database.sh uv run pytest experiments/integrated-p0/tests -k ops_004`. Evidence directory: `experiments/integrated-p0/evidence/2026-08-17-60807cb/`.
