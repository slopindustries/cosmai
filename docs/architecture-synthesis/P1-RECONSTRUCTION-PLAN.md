...
|---|---|---|
| M1 | `platform_core`, plus DB provisioning and migration on the shared PostgreSQL server ([DP-032](../decisions/DP-032-p1-database-placement.md)) — done 2026-08-21, [M1-RECORD](../p1/M1-RECORD.md) | — |
