...
| `addons/importer.local.jsonl` | working tree | `public` | `test_importer_local_jsonl.py` (14 cases) | `ARCHIVE_REFERENCE_ONLY` | [OQ-001](../open-questions/OQ-001-source-capability.md) dataset half | P1 owner | Exists to prove the import *path*; reads a file this project authored |
