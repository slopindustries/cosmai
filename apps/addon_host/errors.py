...
Copy-adapted verbatim from ``experiments/integrated-p0/addon_host/errors.py``
(M3 batch 3b). ``platform_core.errors`` already carries the full CONTRACT-JOB@0.1
error table this module translates into (built in M1), so nothing here changes.
