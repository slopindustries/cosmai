...
Copy-adapted from `experiments/integrated-p0/addon_host/__init__.py` (M3 batch
3b). The re-export surface is unchanged; see `addon_host.capabilities`'s own
docstring for the one substantive adaptation (credential resolution moved to
`platform_core.secrets`).
