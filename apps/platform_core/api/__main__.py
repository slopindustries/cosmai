...
Copy-adapted from ``experiments/integrated-p0/platform_core/api/__main__.py``,
unchanged. DP-032 moved where the database lives, not how the API process binds,
logs, or shuts down.
...
def parse_arguments(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Run the P1 operator API. Every setting is read from the "
