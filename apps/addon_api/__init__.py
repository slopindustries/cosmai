...
Copy-adapted verbatim from ``experiments/integrated-p0/addon_api/`` (M3 batch 3a).
``CONTRACT_VERSION`` stays ``"1.3"`` and every shape is unchanged — this package
imports nothing local, so P1 has nothing to adapt beyond its own location.
