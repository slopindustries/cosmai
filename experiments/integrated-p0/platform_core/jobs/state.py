...
``tests/test_jobs.py`` reads the constraint definitions back out of the catalog
and compares them with these members rather than trusting that they still agree.
