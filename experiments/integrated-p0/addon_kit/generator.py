...
#: `experiments/integrated-p0/addons`. Mirrors `addon_host.settings.DEFAULT_ADDON_DIR`
#: by construction rather than by import: that module lives in a package this one
#: may not depend on, and the path is two lines of `pathlib`, not a shared secret.
