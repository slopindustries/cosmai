...
handoff rather than repaired by editing a package this work package may not
touch.
...
#: ``experiments/integrated-p0/addons``. This file sits one directory below the
#: experiment root, which is also where ``platform_core`` and ``addon_api`` live.
