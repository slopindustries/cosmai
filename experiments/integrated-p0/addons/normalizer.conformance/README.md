...
Generated by `addon_kit new normalizer.conformance --kind normalizer`. This is a skeleton, not
...
function with what `normalizer.conformance` actually does.

## What the normalizer kind is granted
